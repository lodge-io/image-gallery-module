...
class Applet extends Component {
  ...
  render() {
    return (
      <PhotoView>
        <Carousel show={this.state.showPhotoModal} handleClose={this.togglePhotoCarouselDisplay} 
           scrollImg={this.scrollImg} handleClickOnCarouselPhoto={this.handleClickOnCarouselPhoto}
           prevSliderLocation={this.state.prevSliderLocation} newSliderLocation={this.state.newSliderLocation}
           index={this.state.index} pics={this.state.sortedPhotosArr} texts={this.state.sortedTextArr}/>
        <Share show={this.state.showShareModal} handleClose={this.toggleShareButtonModal}/>
        <Save show={this.state.showSaveModal} handleClose={this.toggleSaveButtonModal}/>
        <PrimaryPhoto>
          <PhotoElement srcThumb={this.state.sortedThumbsArr && this.state.sortedThumbsArr[0]} srcBig={this.state.sortedPhotosArr && this.state.sortedPhotosArr[0]} wait={this.state.wait} onClick={this.handleClickOnDisplayPhoto.bind(null, 0)}/>
        </PrimaryPhoto>
        <SecondaryPhotos>
          <PhotoGrid>
            <PhotoElement srcThumb={this.state.sortedThumbsArr && this.state.sortedThumbsArr[1]} srcBig={this.state.sortedPhotosArr && this.state.sortedPhotosArr[1]} wait={this.state.wait} onClick={this.handleClickOnDisplayPhoto.bind(null, 1)}/>
          </PhotoGrid>
          <PhotoGrid>
            <PhotoElement srcThumb={this.state.sortedThumbsArr && this.state.sortedThumbsArr[2]} srcBig={this.state.sortedPhotosArr && this.state.sortedPhotosArr[2]} wait={this.state.wait} onClick={this.handleClickOnDisplayPhoto.bind(null, 2)}/>
          </PhotoGrid>
        </SecondaryPhotos>
        <TertiaryPhotos>
          <PhotoGrid>
        ...
        <SaveButton onClick={this.toggleSaveButtonModal}><SaveButtonIcon viewBox="0 0 129 129">
        ...
        <PhotoButton onClick={this.togglePhotoCarouselDisplay}>View Photos</PhotoButton>
      </PhotoView>
    );
  }
}
